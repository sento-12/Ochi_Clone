...
const Footer = () => {
  return (
    <div className="p-20">
    <div className="w-full h-screen flex  border-t-[1px] border-zinc-500  ">
      <div className="w-1/2  font-['Founders Grotesk'] flex flex-col justify-between font-bold">
        <div className="">
          <h1 className="text-[5vw] leading-none  "> EYE-</h1>
          <h1 className="text-[5vw] leading-none ">OPENING</h1>
        </div>
        <div className="">
          <svg
            width="72"
      ...
      <div className="w-1/2     ">
            <h1 className="text-[5vw] leading-none font-bold  ">PRESENTATIONS</h1>
            <div className="p-7">
                <div className="">
                <p className="text-[35px]">S :</p>
                {["Instagram", "Facebook", "Twitter", "YouTube"].map((item, index)=>{
                    return (
                        <div key={index} className="">
                            <a className="text-[17px]" href="#"> {item} </a>
                        </div>
                    )
                })}
                </div>               
            ...
            <div className="p-7 flex  gap-5">
                ...
                <p className="text-[35px] py-4f">L :</p>
                {["202-1965 W 4th Ave","Vancouver, Canada","30 Chukarina StLviv", "Ukraine"].map((item, index)=>{
                    return (
                        <div key={index} className="py-1 gap-5">
                            <a className="text-[17px]" href="#"> {item} </a>
                        </div>
                    )
                })}
                </div> 
                <div className="w-1/2 flex flex-col items-end   leading-none">
                <div className="">
                <p className="text-[35px] py-4">M :</p>
                {["Home", "Service", "Our Work", "Contact Us"].map((item, index)=>{
                    return (
                        <div key={index} className="py-1 flex items-end">
                            <a className="text-[17px]" href="#"> {item} </a>
                        </div>
                    )
                })}
